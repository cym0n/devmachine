...
"Move current working directory to file directory
"Current directory must be the file directory to make all commands work
function! s:SetCurrentForGit()
    let b:curr = getcwd()
    lcd %:p:h
endfunction

"Unsetter designed for conservative purpose
function! s:UnsetCurrentForGit()
    silent execute "lcd " . b:curr
endfunction
